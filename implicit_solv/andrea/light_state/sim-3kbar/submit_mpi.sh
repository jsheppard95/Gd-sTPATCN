...
#SBATCH -J 2V1A_light_implicit_solv_3kbar   # Job name
#SBATCH -o output  
#SBATCH -e error  
...
mpirun -np $SLURM_NPROCS pmemd.MPI -ref 2v1a_min.rst7 -O -i sim.in -o 2v1a-MD.out -c 2v1a_min.ncrst -p 2v1a.prmtop -r 2v1a-MD.ncrst -x 2v1a-MD.nc > logfile
